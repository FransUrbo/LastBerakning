...
// $Id: index.php,v 1.1 2010-02-16 22:09:04 turbo Exp $
  ...
  <body>
    <table>
      <form method="post" name="berakning":
        ...
        <tr>
          <td></td>
          <td colspan="2"><font size="-2">* Endast nödvändig om fordonståg beräknas</font></td>
        </tr>

        <!-- ---------------------------------- -->

        <tr>
          <td colspan="3"><h1>Släp:</h1></td>
        </tr>
...
// }}}
  ...
  for($bk = 1; $bk <= 3; $bk++) {
	...
	$fh = fopen($name, 'r') or die("Kan inte �ppna bruttoviktstabell filerna!<br>");
...
echo "<p><p><font size=\"-1\">Lastber&auml;rkningsprogram, Copyleft<br>Turbo Fredriksson &lt;turbo@bayour.com&gt;</font><br>";
